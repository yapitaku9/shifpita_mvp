...
def seed_command():
    ...
    desired_shift_types = [
        ...
        {'name': '遅1', 'start_time': datetime.time(13, 0), 'end_time': datetime.time(22, 0)},
        {'name': '遅2', 'start_time': datetime.time(14, 0), 'end_time': datetime.time(23, 0)},
        {'name': '遅3', 'start_time': datetime.time(15, 0), 'end_time': datetime.time(0, 0)},
        {'name': '夜1', 'start_time': datetime.time(22, 0), 'end_time': datetime.time(7, 0)},
        {'name': '夜2', 'start_time': datetime.time(23, 0), 'end_time': datetime.time(8, 0)},
