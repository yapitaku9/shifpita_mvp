...
def dashboard():
    ...
    # 希望勤務では「明」も申請可能にする（管理者側の優先シフト/NG勤務には含めない）
    shift_choices = get_selectable_shift_choices(employment_type, exclude_non_working=True, coerce_int=True, allow_ake=True)
